...
class Admin::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post admin_products_url, params: { admin_product: { description: @admin_product.description, price: @admin_product.price, product_name: @admin_product.product_name, vendor_code: @admin_product.vendor_code } }
    end
  ...
  test "should update admin_product" do
    patch admin_product_url(@admin_product), params: { admin_product: { description: @admin_product.description, price: @admin_product.price, product_name: @admin_product.product_name, vendor_code: @admin_product.vendor_code } }
